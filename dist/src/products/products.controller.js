...
__decorate([
    (0, common_1.Get)(),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN, user_role_enum_1.UserRole.SUPER_ADMIN, user_role_enum_1.UserRole.MANAGER),
    (0, swagger_1.ApiOperation)({ summary: "List products with pagination" }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: "Upserts each item in `products` by unique `sku`. Set `updateExisting` to false to skip existing SKUs instead of updating them.",
    }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: "No request body. Loads the built-in Vollmax / Nytron / other oil SKUs and upserts by SKU. Safe to run multiple times when `updateExisting` is true (default).",
    }),
...
__decorate([
    (0, common_1.Get)(":id"),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN, user_role_enum_1.UserRole.SUPER_ADMIN, user_role_enum_1.UserRole.MANAGER),
    (0, swagger_1.ApiOperation)({ summary: "Get product by id with inventory rows" }),
    (0, swagger_1.ApiOkResponse)({ type: product_entity_1.Product }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN, user_role_enum_1.UserRole.SUPER_ADMIN),
    (0, swagger_1.ApiOperation)({ summary: "Increase product stock" }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN, user_role_enum_1.UserRole.SUPER_ADMIN),
    (0, swagger_1.ApiOperation)({ summary: "Decrease product stock" }),
    (0, swagger_1.ApiBody)({ type: adjust_product_stock_dto_1.AdjustProductStockDto }),
    (0, swagger_1.ApiOkResponse)({ type: product_entity_1.Product }),
    openapi.ApiResponse({ status: 200, type: require("./entities/product.entity").Product }),
    __param(0, (0, common_1.Param)("id", common_1.ParseIntPipe)),
