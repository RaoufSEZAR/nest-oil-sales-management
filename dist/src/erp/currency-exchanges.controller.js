...
exports.ErpCurrencyExchangesController = void 0;
...
let ErpCurrencyExchangesController = class ErpCurrencyExchangesController {
...
exports.ErpCurrencyExchangesController = ErpCurrencyExchangesController;
__decorate([
    (0, common_1.Get)(),
    ...
    (0, swagger_1.ApiOperation)({ summary: "List currency exchanges" }),
    openapi.ApiResponse({ status: 200, type: [require("./entities/currency-exchange.entity").CurrencyExchange] }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], ErpCurrencyExchangesController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(":id"),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN, user_role_enum_1.UserRole.SUPER_ADMIN, user_role_enum_1.UserRole.MANAGER),
    (0, swagger_1.ApiOperation)({ summary: "Get exchange by id" }),
    openapi.ApiResponse({ status: 200, type: require("./entities/currency-exchange.entity").CurrencyExchange }),
    __param(0, (0, common_1.Param)("id", common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], ErpCurrencyExchangesController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN, user_role_enum_1.UserRole.SUPER_ADMIN),
    (0, swagger_1.ApiOperation)({ summary: "Create currency exchange" }),
    ...
    __metadata("design:returntype", void 0)
], ErpCurrencyExchangesController.prototype, "create", null);
exports.ErpCurrencyExchangesController = ErpCurrencyExchangesController = __decorate([
    (0, swagger_1.ApiTags)(api_tags_1.SwaggerTags.ErpCurrencyExchanges),
    (0, common_1.Controller)("currency-exchanges"),
...
//# sourceMappingURL=currency-exchanges.controller.js.map