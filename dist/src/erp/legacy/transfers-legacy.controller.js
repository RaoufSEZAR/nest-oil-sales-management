...
exports.TransfersLegacyController = void 0;
...
let TransfersLegacyController = class TransfersLegacyController {
...
exports.TransfersLegacyController = TransfersLegacyController;
__decorate([
    (0, common_1.Get)(),
...
], TransfersLegacyController.prototype, "findAll", null);
__decorate([
    (0, common_1.Get)(":id"),
    (0, roles_decorator_1.Roles)(...user_role_enum_1.ERP_MANAGEMENT_ROLES),
    openapi.ApiResponse({ status: 200, type: require("../entities/inventory-transfer.entity").InventoryTransfer }),
    ...
    __metadata("design:returntype", void 0)
], TransfersLegacyController.prototype, "findOne", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:returntype", void 0)
], TransfersLegacyController.prototype, "create", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], TransfersLegacyController.prototype, "complete", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Number]),
    __metadata("design:returntype", void 0)
], TransfersLegacyController.prototype, "cancel", null);
__decorate([
    (0, common_1.Patch)(":id"),
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN, user_role_enum_1.UserRole.SUPER_ADMIN),
    openapi.ApiResponse({ status: 200, type: require("../entities/inventory-transfer.entity").InventoryTransfer }),
    ...
    __metadata("design:returntype", void 0)
], TransfersLegacyController.prototype, "update", null);
exports.TransfersLegacyController = TransfersLegacyController = __decorate([
    (0, swagger_1.ApiTags)("Transfers (legacy)"),
...
//# sourceMappingURL=transfers-legacy.controller.js.map